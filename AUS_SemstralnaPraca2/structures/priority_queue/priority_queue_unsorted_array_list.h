...
namespace structures
{
	...
	{
		// miesto tohto tela, by stacilo zavolat len metodu predka PriorityQueueList::pop()
		// lenze ta pouziva na odstranenie list->removeAt() ... a v ArrayListe sa potom
		// musia presuvat prvky dolava -> O(n), co je zbytocne, lebo tento front je neutriedeny
		// a staci len prvok vymenit za posledny a popnut ho -> O(1)
